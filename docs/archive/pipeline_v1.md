> **Archived** — This document describes the legacy production pipeline (v1). It is preserved for historical reference only. The pipeline described here has been superseded by the current research-oriented validation framework. See the root README.md for current project status.

---

# Pipeline README (Archived — pipeline_v1)
